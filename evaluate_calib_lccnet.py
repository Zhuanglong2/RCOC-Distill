...
def config():
    ...
    dataset = 'Dual_Radar'  # NTU4DRadLM     Dual_Radar
    data_folder =  '/home/long/Datasets/Dual_Radar-Calib' #NTU4DRadLM-Calib   Dual_Radar-Calib
    ...
    optimizer = 'adam'
    resume = False   # True
    weights = '/home/long/PycharmProjects/RCOC-Distill/DualRadar-lccnet/val_seq_00/pointnet/checkpoint_r10.00_t0.20_e120_0.015.tar'
    rescale_rot = 1.0
