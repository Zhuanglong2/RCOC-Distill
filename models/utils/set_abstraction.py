...
from models.utils.sampling import fps
from models.utils.grouping import ball_query
from models.utils.common import gather_points
...
def sample_and_group(xyz, points, M, radius, K, use_xyz=True):
    ...
    grouped_inds = torch.clamp(grouped_inds, 0, xyz.shape[1] - 1) #防止超出索引
