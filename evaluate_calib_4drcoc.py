...
def config():
    ...
    optimizer = 'adam'
    resume = False   # True
    weights = '/home/long/PycharmProjects/RCOC-Distill/NTU4DRadLM-4DRCOC/val_seq_06/pointnet/checkpoint_r10.00_t0.20_e990_0.062.tar'
    rescale_rot = 1.0
...
def main(_config, _run, seed):
    ...
    for batch_idx, sample in enumerate(ValImgLoader):
        ...
        loss, trasl_e, rot_e, R_predicted, T_predicted = val(model, rgb_resize, lidar_resize, lidar_input_gt,
